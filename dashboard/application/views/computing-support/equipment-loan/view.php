...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-lg-12">
            <h1 class="page-header">Equipment Loan</h1>
            <?= form_open() ?>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control name" id="full_name" name="full_name" placeholder="Enter staff full name" value="<?= set_value('full_name') ?>">
            </div>
            <div class="form-group">
                <label for="ern">Employee Reference no. *</label>
                <input type="text" class="form-control" id="ern" name="ern" placeholder="Enter staff employee reference no." value="<?= set_value('ern') ?>">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="sn">Device serial number *</label>
            ...
            <a href="https://intranet.cant-col.ac.uk/application/files/2114/6842/1036/IT_Equipment_Loan_Policy.pdf"> IT Equipment Loan Policy.pdf</a>
        </div> <!-- END col-lg-12 -->
    </div> <!-- END row -->
