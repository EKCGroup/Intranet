...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-lg-12">
            <h1 class="page-header">Room Move Pending</h1>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <!--<label>Please give a reason?</label>-->
                                <!--<textarea class="form-control" rows="3" id="re-reason" name="re-reason" placeholder="Enter reason"></textarea>--></div>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <h4><b>Are you sure you want to reject this request?</b></h4><br>
                                <!--<label>Please give a reason?</label>-->
                                <!--<textarea class="form-control" rows="3" id="rc-reason" name="rc-reason" placeholder="Enter reason"></textarea>--></div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
