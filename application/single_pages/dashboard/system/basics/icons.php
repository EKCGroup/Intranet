...
<form method="post" id="modern-form" class="form-horizontal" action="<?php echo $view->action('update_modern_thumbnail'); ?>" >
    ...
    <fieldset>
        <legend><?php echo t('Android and Windows Start Colour'); ?></legend>
        <div class="help-block"><?php echo t('Please select a colour for the Android and Windows Start Colour.'); ?></div>
        <?php
